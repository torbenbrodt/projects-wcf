...
<input type="hidden" name="projectShortNameOld" value="{@$projectShortName}" />
<input type="hidden" name="projectInternOld" value="{@$projectIntern}" />
...
<script type="text/javascript">
	//<![CDATA[
	inlineHelp.register('projectShortName','projectWebsite','projectSvn','projectIntern');
	onloadEvents.push(function() { if ({$project}) enableOptions('projectShortName','projectWebsite','projectSvn','projectIntern'); else disableOptions('projectShortName','projectWebsite','projectSvn','projectIntern') });
	//]]>
</script>
